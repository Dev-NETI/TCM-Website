    ...
    <div class="relative container bg-white mx-auto flex justify-center lg:justify-end px-12">
        <div class="relative w-[500px] h-full py-6 bg-white z-20 p-12 py-16 rounded-sm">
            ...
            <div class="flex flex-col gap-8 mb-8">
                <p class=""><span class="font-bold">Transnational Diversified  Group (TOG)</span> is a globally competitive and progressive business group of successful and diverse companies.</p>
                ...
                <p><span class="font-bold">TOG Maritime</span> operates under TDG's Ship Management Division which engages in Total Ship Management including crew management, seafarer training , maritime education. ship management . and medical
